...
class _$_UserEntity extends _UserEntity {
  const _$_UserEntity(
      {this.id, this.name, this.email, this.emailVerified, this.photoURL})
      : super._();
  ...
  @override
  String toString() {
    return 'UserEntity(id: $id, name: $name, email: $email, emailVerified: $emailVerified, photoURL: $photoURL)';
  }
