...
class CapybaSocialTextFieldController extends TextEditingController {
  List<String? Function(String)> validators;
  void Function(String)? onChanged;
  late BehaviorSubject<CapybaSocialTextFieldControllerState> _subject;
  ...
  Stream<CapybaSocialTextFieldControllerState> get stream =>
      _subject.stream.shareReplay(maxSize: 1);

  CapybaSocialTextFieldController(
    String? value, {
    bool dirty = false,
    bool touched = false,
    ...
    final initialState = CapybaSocialTextFieldControllerState(
      dirty: dirty,
      touched: touched,
...
@immutable
class CapybaSocialTextFieldControllerState {
  final bool dirty;
  final bool touched;
  ...
  CapybaSocialTextFieldControllerState copyWith({
    bool? dirty,
    bool? touched,
    ...
    return CapybaSocialTextFieldControllerState(
